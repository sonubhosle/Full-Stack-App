...
const ProductError = ({ name,message }) => {
        ...
        <div className='relative w-full  flex  items-center  justify-center overflow-hidden  '>
            ...
            <div className='relative z-10 w-150 max-w-2xl mx-auto py-10  text-center'>
                ...
                <div className=' bg-white rounded-3xl p-6 border border-gray-200 '>
                    ...
                    {/* 404 Heading */}
                    <h1 className='text-6xl sm:text-8xl lg:text-9xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-slate-900 via-slate-500  to-slate-900 bg-clip-text text-transparent '>
                        404
                    </h1>
                    {/* Title */}
                    <div className="">
                        <h2 className='text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 text-red-400 '>
                            We couldn't find
                        </h2>
                        {/* Product Name */}
                        {name && (
                            <div className="inline-flex mb-4 capitalize font-semibold items-center space-x-2 bg-red-500/10 border border-red-500/20 rounded-full px-4 py-2">
                               <Zap className="text-red-400 w-5 h-5"  />
                                ...
                                <span className="text-red-400 text-lg font-semibold">{message} {name}</span>
                            </div>
                        )}
                    </div>
